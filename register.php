...
if(
  ...
  // Bloc des vérifs
    ...
    if(!preg_match('/^[\p{L}\w]{2,25}$/iu', $_POST['pseudonym'])){
        $errors[] = 'Le pseudonyme doit contenir uniquement entre 1 et 50 caractères, composés de lettre min/maj, de chiffres, de caractères accentués et de l\'underscore !';
    }
        ...
        ?>
                        ...
                        <form action="register.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="g-recaptcha" data-sitekey="6LfiYncfAAAAAAz0oy37Q59KeX9sul4BerFEYfE-"></div>
                            </div>
                            <div>
